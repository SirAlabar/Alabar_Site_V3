        ...
        <div class="grimoire-container">
          <div class="container-rpg py-2 pl-16">
            <header class="text-center mb-8">
              ...
              <p class="font-game text-base text-rpg-text">Software Developer & Game Enthusiast</p>
            </header>
            ...
            <div class="max-w-4xl mx-auto">
              ...
              <div class="card-rpg mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <p class="font-game text-rpg-text text-sm mb-2">Class: <span class="text-rpg-accent">Software Developer</span></p>
                    <p class="font-game text-rpg-text text-sm mb-2">Former Class: <span class="text-rpg-accent">Accountant</span></p>
                    <p class="font-game text-rpg-text text-sm mb-2">Level: <span class="text-rpg-accent">34</span></p>
                    <p class="font-game text-rpg-text text-sm mb-2">Guild: <span class="text-rpg-accent">42 Porto</span></p>
                    <p class="font-game text-rpg-text text-sm">Base: <span class="text-rpg-accent">Porto, Portugal</span></p>
                  </div>
                  <div>
                    <p class="font-game text-rpg-text text-sm mb-3">Interests:</p>
                    <div class="space-y-2">
                      <div class="flex items-center gap-2">
                        <span class="text-rpg-accent">⚔️</span>
                        <span class="font-game text-rpg-text text-sm">Game Development</span>
                      </div>
                      <div class="flex items-center gap-2">
                        <span class="text-rpg-accent">🎨</span>
                        <span class="font-game text-rpg-text text-sm">Pixel Art</span>
                      </div>
                      <div class="flex items-center gap-2">
                        <span class="text-rpg-accent">🏛️</span>
                        <span class="font-game text-rpg-text text-sm">System Architecture</span>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <!-- Current Quest -->
              <div class="card-rpg">
                <h2 class="font-pixel text-xl text-rpg-accent mb-4">Current Quest</h2>
                <div class="bg-rpg-darker/50 p-4 rounded">
                  <p class="font-game text-rpg-text text-sm leading-relaxed">
