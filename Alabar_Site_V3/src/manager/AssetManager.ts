...
export class AssetManager 
{
    ...
    textures: Record<string, PIXI.Texture | PIXI.Spritesheet>;
    backgrounds: Record<string, Record<string, PIXI.Texture>>;
    spritesheets: Record<string, PIXI.Spritesheet>;
    isLoading: boolean;

    assetPaths: {
        player: { spritesheet: string; data: string };
        monsters: Record<string, { spritesheet: string; data: string }>;
        clouds_spritesheet: { texture: string; data: string };
        backgrounds: Record<string, Record<string, string>>;
        ui: { cursors: Record<string, string> };
    };
		...
		try 
		{
			...
			for (const bundleName of bundleNames) 
			{
				try 
				{
					...
					processLoadedResources(bundleName: string, resources: Record<string, any>): void
					loadedBundles++;
				} 
				catch (error) 
				{
