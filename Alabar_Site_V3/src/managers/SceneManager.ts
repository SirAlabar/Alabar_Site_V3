...
export class SceneManager
{
  ...
  applySpecialEffects(theme: Theme): void
  {
    if (theme === 'dark' && this.layers['moon'])
    {
      ...
      {
        const moonSprite = moonContainer.children[0] as Sprite;
        
        // Add a soft glow filter would go here
